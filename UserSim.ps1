...
Set-ItemProperty $runonce Start_User_Sim_Browsing "schtasks /create /u specterpops\corpadmin /p corpP@ssw0rd! /ru specterpops\$($username) /rp $($password) /it /tn AutoIT_Browsing /sc MINUTE /mo 5 /tr C:\Users\Public\UserActions\UserDocument.exe /f"
