...
Set-ItemProperty $runonce Start_User_Sim_Browsing "schtasks /create /u testadmin /p P@ssw0rd! /ru specterpops\$($username) /rp $($password) /it /tn AutoIT_Browsing /sc MINUTE /mo 5 /tr C:\Users\Public\UserActions\UserBrowsing.exe /f"
